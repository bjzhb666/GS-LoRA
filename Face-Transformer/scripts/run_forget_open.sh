...
# python3 -u train_own_forget_open.py -b 48 -w 0 -d casia100 -n VIT -e 100 \
#     -head CosFace  --grouping block --data_ratio $RATIO --alpha_epoch 0 --open_cls_num $OPEN \
#     --outdir /data1/zhaohongbo/exps/forget-CL-open/L2-0.01-ratio${RATIO}$start${NUM_FIRST_CLS}forget${PER_FORGET_CLS}lr${lr}open${OPEN} \
#     --warmup-epochs 0 --lr $lr --num_workers 8  --lora_rank 0 --decay-epochs 100 --wandb_group forget-open-baseline-new \
#     --vit_depth 6 --num_of_first_cls $NUM_FIRST_CLS --per_forget_cls $PER_FORGET_CLS \
#     -r /data/zhaohongbo/Github/amnesic-face-recognition/Face-Transformer/results/ViT-P8S8_casia100_cosface_s1-1200-150de-depth6-new/Backbone_VIT_Epoch_1110_Batch_82100_Time_2023-10-18-18-22_checkpoint.pth \
#     --min-lr 1e-5  --one_stage --l2 --l2_lambda 0.01 --replay 
# done
# done
# done
...
python3 -u train_own_forget_open.py -b 48 -w 0 -d casia100 -n VIT -e 100 \
    -head CosFace  --grouping block --data_ratio $RATIO --alpha_epoch 0 --open_cls_num $OPEN \
    --outdir /data1/zhaohongbo/exps/forget-CL-open/EWC10-ratio${RATIO}$start${NUM_FIRST_CLS}forget${PER_FORGET_CLS}lr${lr}open${OPEN} \
    --warmup-epochs 0 --lr $lr --num_workers 8  --lora_rank 0 --decay-epochs 100 --wandb_group forget-open-baseline-new \
    --vit_depth 6 --num_of_first_cls $NUM_FIRST_CLS --per_forget_cls $PER_FORGET_CLS \
    -r /data/zhaohongbo/Github/amnesic-face-recognition/Face-Transformer/results/ViT-P8S8_casia100_cosface_s1-1200-150de-depth6-new/Backbone_VIT_Epoch_1110_Batch_82100_Time_2023-10-18-18-22_checkpoint.pth \
...
# # MAS
# for open in 5 10 15 20 25 30 35
# do
# for lr in 1e-4
# do
# for beta in 0.1
...
# python3 -u train_own_forget_open.py -b 48 -w 0 -d casia100 -n VIT -e 100 \
#     -head CosFace  --grouping block --data_ratio $RATIO --alpha_epoch 0 --open_cls_num $open \
#     --outdir /data1/zhaohongbo/exps/forget-CL-open/MAS1-ratio${RATIO}$start${NUM_FIRST_CLS}forget${PER_FORGET_CLS}lr${lr}open${OPEN} \
#     --warmup-epochs 0 --lr $lr --num_workers 8  --lora_rank 0 --decay-epochs 100 --wandb_group forget-open-baseline-new \
#     --vit_depth 6 --num_of_first_cls $NUM_FIRST_CLS --per_forget_cls $PER_FORGET_CLS \
#     -r /data/zhaohongbo/Github/amnesic-face-recognition/Face-Transformer/results/ViT-P8S8_casia100_cosface_s1-1200-150de-depth6-new/Backbone_VIT_Epoch_1110_Batch_82100_Time_2023-10-18-18-22_checkpoint.pth \
...
# python3 -u train_own_forget_open.py -b 48 -w 0 -d casia100 -n VIT -e 100 \
#     -head CosFace  --grouping block --data_ratio $RATIO --alpha_epoch 0 --open_cls_num $OPEN \
#     --outdir /data1/zhaohongbo/exps/forget-CL-open/retrain-ratio${RATIO}$start${NUM_FIRST_CLS}forget${PER_FORGET_CLS}lr${lr}open${OPEN} \
#     --warmup-epochs 0 --lr $lr --num_workers 8  --lora_rank 0 --decay-epochs 100 --wandb_group forget-open-baseline-new \
#     --vit_depth 6 --num_of_first_cls $NUM_FIRST_CLS --per_forget_cls $PER_FORGET_CLS \
#     -r /data/zhaohongbo/Github/amnesic-face-recognition/Face-Transformer/results/ViT-P8S8_casia100_cosface_s1-1200-150de-depth6-new/Backbone_VIT_Epoch_1110_Batch_82100_Time_2023-10-18-18-22_checkpoint.pth \
