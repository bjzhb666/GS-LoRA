...
python3 -u train_own.py -b 480 -w 0,1 -d casia100 -n VIT \
-head CosFace --outdir ./results/ViT-P8S8_casia100_cosface_s1 \
--warmup-epochs 1 --lr 3e-4 --num_workers 8  --lora_rank 0
