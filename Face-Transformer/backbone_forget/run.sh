...
python3 -u backbone_forget_main.py -b 48 -w 0 -d casia100 -n VIT -e 100 \
-head CosFace --outdir ./results/backbone_forget_ours \
--warmup-epochs 0 --lr 3e-4 --num_workers 8  --lora_rank 0 --decay-epochs 150 \
