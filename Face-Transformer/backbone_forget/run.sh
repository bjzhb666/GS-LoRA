...
lr=1e-3
# lr=1e-2
python3 -u backbone_forget_main.py -b 48 -w 0 -d casia100 -n VIT -e 50 --min-lr 1e-5 \
    -head CosFace --outdir /data1/zhaohongbo/exps/forget-CL-backbone-newtry/resultsours-50ep-lr${lr}min0.1 \
    ...
    -r $MODEL_PATH --wandb_group backbone_forget_ours 