...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="lfw,talfw,calfw,cplfw,cfp_fp,agedb_30",
        type=str,
    )
    ...
    # VIT depth
    parser.add_argument(
        "--vit_depth", type=int, default=20, metavar="N", help="vit depth (default: 20)"
    )
    ...
    wandb.init(
        project="face recognition", mode="offline" if args.wandb_offline else "online"
    )
        ...
        for inputs, labels in iter(trainloader):
            ...
            if (
                ...
                for ver in vers:
                    ...
                    buffer_val(
                        name, accuracy, std, xnorm, best_threshold, roc_curve, batch + 1
                    )
