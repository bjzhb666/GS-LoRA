...
if __name__ == '__main__':
    ...
    #                                                            split2_start=st2,
    #                                                            split2_end=en2)
    _,forget_dataset_train = split_dataset(dataset=train_dataset,
                                                                class_order_list=order_list,
                                                                split1_start=st1,
                                                                split1_end=en3,
                                                                split2_start=st2,
                                                                split2_end=en2)
    remain_dataset_test, open_dataset_test = split_dataset(dataset=test_dataset,
                                                                class_order_list=order_list,
                                                                split1_start=st1,
                                                                split1_end=en1,
                                                                split2_start=st3,
                                                                split2_end=en3)
    _, forget_dataset_test = split_dataset(dataset=test_dataset,
                                                                class_order_list=order_list,
                                                                split1_start=st1,
                                                                split1_end=en3,
                                                                split2_start=st2,
    ...
    testloader_remain = torch.utils.data.DataLoader(remain_dataset_test,
                                                ...
                                                num_workers=WORKERS,
                                                drop_last=False)
    testloader_open = torch.utils.data.DataLoader(open_dataset_test,
                                                batch_size=BATCH_SIZE,
                                                shuffle=False,
                                                num_workers=WORKERS,
                                                drop_last=False)
    testloader_remain_all = torch.utils.data.DataLoader(remain_dataset_test_all,
                                                batch_size=BATCH_SIZE,
                                                shuffle=False,
                                                num_workers=WORKERS,
                                                drop_last=False)
    ...
    remain_all_acc_before = eval_data(BACKBONE, testloader_remain_all, DEVICE, 'remain_all', batch)
