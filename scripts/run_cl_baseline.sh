...
#         --num_of_first_cls $NUM_FIRST_CLS --cls_per_phase $CLS_PER_PHASE  --no_aux_loss \
#         --seed_cls 123  \
#         --num_tasks 7 --Der --DER_lambda 0.001
...
#         --num_of_first_cls $NUM_FIRST_CLS --cls_per_phase $CLS_PER_PHASE  --no_aux_loss \
#         --seed_cls 123  \
#         --num_tasks 7 --Der --DER_lambda 0.001 --DER_plus --DER_plus_lambda 0.1
...
#         --num_of_first_cls $NUM_FIRST_CLS --cls_per_phase $CLS_PER_PHASE --no_aux_loss \
#         --seed_cls 123 \
#         --num_tasks 7 --SCRUB_superepoch 3 --sgda_smoothing 0 --SCRUB  \
