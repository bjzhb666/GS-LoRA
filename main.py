...
def get_args_parser():
    ...
    parser.add_argument('--mem_rate', default=0.1, type=float, help='memory rate of the rehearsal set')
    ...
    # rehearsal rate
    parser.add_argument('--rehearsal_rate', default=0.1, type=float, help='rehearsal rate of the rehearsal set')
    parser.add_argument('--rehearsal_epoch', default=50, type=int, help='rehearsal buffer epoch')
    
    # LoRA rank
    parser.add_argument('--lora_rank', default=0, type=int, help='rank of the LoRA model')
    # LoRA position
    parser.add_argument('--lora_pos', default=['None'], choices=['encoder', 'decoder', 'proj_layer','None'] ,help='position of the LoRA model')
    # LoRA checkpoint
    parser.add_argument('--lora_checkpoint', default=None, type=str, help='checkpoint of the LoRA model')
    return parser
        ...
        if phase_idx==0:
            ...
            if args.balanced_ft and phase_idx >= 1:
                for epoch in range(0, 20):
                    ...
                    test_stats, coco_evaluator, all_maps = evaluate(model, criterion, postprocessors, data_loader_val, base_ds, device, args.output_dir)
