...
def train_one_epoch_l2(model:torch.nn.Module,
    ...
    for _ in metric_logger.log_every(range(len(data_loader_cl_forget)), print_freq, header):
        ...
        l2_loss = get_l2_loss(model, regularization_terms)
...
def train_one_epoch_mas():
    pass

def train_one_epoch_SI():
    pass

def train_one_epoch_l2_replay():
    pass

def train_one_epoch_mas_replay():
    pass

def train_one_epoch_SI_replay():
    pass

def train_one_epoch_ewc_replay():
    pass
